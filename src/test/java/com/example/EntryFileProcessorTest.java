import com.example.EntryFileProcessor;
...
public class EntryFileProcessorTest {

    @Test
    public void testProcessValidFile() throws IOException {
        ...
        EntryFileProcessor entryFileProcessor = new EntryFileProcessor();

        ByteArrayInputStream inputStream = new ByteArrayInputStream(inputContent.getBytes());

        List<Record> records = entryFileProcessor.process((InputStream) entryFileReader.read(inputStream));
